    ...
    return (
      <Box className={classes.classBox}>
        <Box className={classes.info}>
          <h2>Druid Class Features</h2>
          <h3>Hit Points</h3>
          <Typography>
            <strong>Hit Dice:</strong> 1d8 per druid level
            <br />
          ...
          <h3>Proficiencies</h3>
          <Typography>
            <strong>Armor:</strong> Light armor, medium armor, shields (druids
            will not wear armor or use shields made of metal)
            <br />
            <strong>Weapons:</strong> Clubs, daggers, darts, javelins, maces,
            quarterstaffs, scimitars, sickles, slings, spears
            <br />
            <strong>Tools:</strong> Herbalism kit
            <br />
            <strong>Saving Throws:</strong> Intelligence, Wisdom
            <br />
            <strong>Skills:</strong> Choose two from Arcana, Animal Handling,
        ...
        <Box className={classes.actions}>
          ...
          <Button
            ...
            className={classes.buttons}
            onClick={() => {
              this.props.state.update_Class("Druid", [
                "arca",
                "anim",
                "insi",
                "medi",
...
export default withStyles(styles, { withTheme: true })(Druid);
